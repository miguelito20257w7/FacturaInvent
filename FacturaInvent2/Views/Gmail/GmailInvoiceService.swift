//
//  GmailInvoiceService.swift
//  FacturaInvent2
//
//  Portado de v1; convertido a @Observable. Lista los correos con facturas
//  adjuntas y descarga el XML (descomprimiendo el ZIP si hace falta).
//
...
@MainActor
@Observable
final class GmailInvoiceService {

    var mensajes: [GmailMessageDetail] = []
    var isLoading = false
